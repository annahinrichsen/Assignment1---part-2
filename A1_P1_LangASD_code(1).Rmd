...
```{r}
demo_train = read.csv("~/Desktop/R Saves Semester 3/Assignment1/demo_train(1).csv")
LU_train <- read.csv("~/Desktop/R Saves Semester 3/Assignment1/LU_train.csv")
token_train <- read.csv("~/Desktop/R Saves Semester 3/Assignment1/token_train.csv")
```
